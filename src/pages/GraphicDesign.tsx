...
const GraphicDesign: React.FC = () => {
  ...
  const cards = [
    ...
    //   link: '/projects/chammie',
    //   onCardClick: () => handleCardClick('chammie'),
    // },
    {
        ...
        <div className="xl:w-[70%] lg:w-[90%] md:w-full sm:w-full
          ...
          <div id="first row of squares" className="grid grid-cols-2 gap-0 w-full justify-end">
            ...
            <div className="col-start-2 ">
              <div className="grid grid-cols-3 gap-0 justify-end">
          ...
          <div className="grid col-span-2 grid-cols-1 
            ...
            <div className="col-start-1 col-span-6 flex items-left justify-left">
              <span className="py-0">
                <p className="pt-8 mt-12 font-[Instrument] text-2xl 2xl:text-[3rem] lg:text-xl 2xs:text:xl">
                  See My Graphic Design Resume ☼
                </p>
